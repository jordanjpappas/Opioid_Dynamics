...
# (6b) What are the top-15 or 20 counties in the U.S. in terms of drug-related disorder deaths for 2018. Two versions of this figure would suffice, for review: 
...
for (dataset in c('Drug-Related Disorders UCOD','Drug-Related Disorders UCOD and CC')){
  ...
  # Clean county_fips
  county_state_fips$state_fips <- stri_pad_left(county_state_fips$state_fips, 2, 0)
  county_state_fips$county_fips <- stri_pad_left(county_state_fips$county_fips, 3, 0)
  ...
  county_rates <- subset(county_rates, year==2018)
