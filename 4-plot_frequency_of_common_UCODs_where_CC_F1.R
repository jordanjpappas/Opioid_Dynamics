...
# (4) What are the top-15 most common underlying causes of death with non-drug overdose deaths with a F1* contributing, but not underlying, cause of death? 2015-2018 for this one + one for the entire time period
...
# Clean data
  ...
  # Filter years
  all_deaths <- subset(all_deaths, year >= 2015 & year <= 2018)
...
# Plot data
  ...
  png('Opioids_CCs/Figures/Figure_(4)_2014_2018.png',width=600,height=600)
